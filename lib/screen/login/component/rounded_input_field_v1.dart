...
class RoundedInputFieldV1 extends StatefulWidget {
  ...
  @override
  _RoundedInputFieldV1State createState() => _RoundedInputFieldV1State();
}

class _RoundedInputFieldV1State extends State<RoundedInputFieldV1> {
